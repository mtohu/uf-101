...
public function __construct($dbhost='10.52.21.1',$dbuser='uf101web',$dbpw='uf101',$dbname='uf101') {
   $this->connect($dbhost,$dbuser,$dbpw,$dbname);
}

function connect($dbhost='10.52.21.1', $dbuser='uf101web', $dbpw='uf101', $dbname = 'uf101', $dbcharset = 'utf8', $pconnect = 1, $tablepre='', $time = 0) {
$this->dbhost = $dbhost;
$this->dbuser = $dbuser;
$this->dbpw = $dbpw;
$this->dbname = $dbname;
